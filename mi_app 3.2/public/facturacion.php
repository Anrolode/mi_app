...
<body>
    ...
    <div id="registro-acciones" class="acciones">
        ...
        <a href="#" id="openModalBtn">
            Generar Factura
            <img id="openModalImg" src="../assets/img/generarfactura.png" width="30" alt="Generar Factura">
        </a>     
        <?php endif; ?>
    </div>
...
<script src="../assets/js/generar_factura.js"></script>
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        openModalBtn.addEventListener("click", function(event) {
            ...
            registerIcon.src = "../assets/img/clicgenerarfactura.png";
        });

        function closeRegisterModal() {
            registerModal.style.display = "none";
            registerIcon.src = "../assets/img/generarfactura.png";
        }
