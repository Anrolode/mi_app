...
<body>
    ...
    <div class="main-container">
        ...
        <?php if ($_SESSION['rol'] === 'admin'): ?>
            ...
            <a href="#" id="openModalBtn">
                Registrar Producto
                <img src="../assets/img/clicregistrarproducto.png" width="30" alt="registrarproducto">
            </a>
            <?php endif; ?>
            <div class="separator"></div>
            <?php if ($_SESSION['rol'] === 'admin'): ?>
    ...
    <script src="../assets/js/registrar_producto.js"></script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        openModalBtn.addEventListener("click", function(event) {
            ...
            registerIcon.src = "../assets/img/clicregistrarproducto.png"; // Cambia la imagen al abrir el modal
        });

        function closeRegisterModal() {
            registerModal.style.display = "none";
            registerIcon.src = "../assets/img/registrarproducto.png"; // Cambia la imagen al cerrar el modal
        }
