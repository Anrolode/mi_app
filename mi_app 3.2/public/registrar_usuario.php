...
<body>
    ...
    <div class="main-container">
        ...
        <a href="#" id="openModalBtn">
             Registrar Usuario<img id="registerIcon" src="../assets/img/clicregistrar.png" width="30" alt="Registrar">
        </a>
            <?php endif; ?>
            <div class="separator"></div>
            <?php if ($_SESSION['rol'] === 'admin'): ?>
        <a href="editar_usuario.php">
             Editar <img src="../assets/img/editar.png" width="30" alt="Editar">
        </a>
        <?php endif; ?>
            <div class="separator"></div>
            <?php if ($_SESSION['rol'] === 'admin'): ?>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        openModalBtn.addEventListener("click", function(event) {
            ...
            registerIcon.src = "../assets/img/clicregistrar.png"; // Cambia la imagen al abrir el modal
        });

        function closeRegisterModal() {
            registerModal.style.display = "none";
            registerIcon.src = "../assets/img/registrar.png"; // Cambia la imagen al cerrar el modal
        }
